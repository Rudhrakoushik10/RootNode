...
By default the template creates a single `HelloWorld` contract under agentic_service_buyer folder in the `smart_contracts` directory. To add a new contract:
